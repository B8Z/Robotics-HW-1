...
'''  by David Conner CPSC 472/PCSC 572 Spring 2021 '''
...
print("rotX pi/2:")
print(rotX(np.pi/2))
print(M2Q(rotX(np.pi/2)))

print("rotY pi/2:")
print(rotY(np.pi/2))
print(M2Q(rotY(np.pi/2)))

print("rotZ pi/2:")
print(rotZ(np.pi/2))
print(M2Q(rotZ(np.pi/2)))

print("rotX pi/3:")
print(rotX(np.pi/3))
print(M2Q(rotX(np.pi/3)))

print("rotY pi/3:")
print(rotY(np.pi/3))
print(M2Q(rotY(np.pi/3)))

print("rotZ pi/3:")
print(rotZ(np.pi/3))
print(M2Q(rotZ(np.pi/3)))

print("rotX pi/4:")
print(rotX(np.pi/4))
print(M2Q(rotX(np.pi/4)))

print("rotY pi/4:")
print(rotY(np.pi/4))
print(M2Q(rotY(np.pi/4)))

print("rotZ pi/4:")
print(rotZ(np.pi/4))
print(M2Q(rotZ(np.pi/4)))

print("rotX pi/6:")
print(rotX(np.pi/6))
print(M2Q(rotX(np.pi/6)))

print("rotY pi/6:")
print(rotY(np.pi/6))
print(M2Q(rotY(np.pi/6)))

print("rotZ pi/6:")
print(rotZ(np.pi/6))
print(M2Q(rotZ(np.pi/6)))
